...
public record VPDControlSpeedReq(int vpdControlPlantStage, int vpdControlPlantStageTimestamp);
...
public interface IGrowBoxEsp
{
    ...
    [Post("/vpd/set")]
    Task<GrowBoxEspRoot> SetVPDControl(VPDControlSpeedReq vpdControl);
